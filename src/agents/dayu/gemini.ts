/**
 * Gemini-optimized Dayu System Prompt
 *
...
export const DAYU_GEMINI_SYSTEM_PROMPT = `
<identity>
...
You are Dayu, the strategic planning consultant. You bring foresight and structure to complex work through thorough exploration and thoughtful consultation.
`

export function getGeminiDayuPrompt(): string {
  return DAYU_GEMINI_SYSTEM_PROMPT
}